    ...
    <>
      ...
      <div style={MODAL_STYLES}  className="custom-modal-content">
        ...
        <div className="navbar-logo"></div>
          ...
          <p>Ci-dessous, vous trouverez des informations sur le traitement de vos données personnelles conformément au RGPD.<br />
          ...
          <p>Lors de la prise en charge de vos données personnelles, BK TRAD met un point d’honneur à veiller au caractère confidentiel du traitement de vos données personnelles.<br />
        ...
        <p>Lorsque vous utilisez nos services, vos données personnelles peuvent être traitées.<br/>
        ...
        <p>Notre déclaration de confidentialité s’applique à l’utilisation de données personnelles par BK TRAD et par le site. Cette déclaration de confidentialité fait partie de notre site Internet.
        </p>
        <h2 className='section-subtitle'>Utilisation de vos données personnelles </h2>
        <p>Nous sommes amenés à utiliser vos données personnelles lors du traitement des demandes d’informations ou lorsque nous vous fournissons des produits et/ou services.<br/>
...
BK TRAD ne vend pas vos données personnelles à des tiers.
        ...
        <p>Vos données personnelles ne seront pas conservées plus longtemps que nécessaire.<br/>
...
Nous conservons certaines données parce que nous sommes tenus de le faire en raison d’une obligation financière et/ou fiscale. Dans ce cas, vos données seront conservées pendant au moins sept ans. Passé ce délai, nous veillerons à ce que vos données personnelles soient soigneusement effacées.<br/>
        ...
        <ul>Vous disposez de différents droits en ce qui concerne vos données personnelles :
          <ol>Vous avez le droit de demander l’accès à vos données personnelles, leur rectification ou leur suppression.</ol>
          <ol>Vous avez le droit de vous opposer au traitement de vos données personnelles.</ol>
        </ul>
        <p>Lorsque vous soumettez une demande, nous évaluons d’abord si nous sommes en mesure de la traiter. Nous ne pouvons pas traiter votre demande si nous n’avons pas pu établir votre identité.<br/>
        ...
        <p>Notre site Internet contient divers liens vers des sites Internet de tiers.
Nous vous conseillons de lire la déclaration de confidentialité du site Internet que vous visitez via notre site Internet. Nous ne pouvons pas être tenus responsables de la manière dont les sites Internet de tiers traitent vos données personnelles.
        ...
        <p>Nous nous réservons le droit d’apporter des modifications à cette déclaration de confidentialité. Nous vous recommandons donc de vérifier régulièrement notre déclaration de confidentialité afin de prendre connaissance d’éventuels changements.
        </p>
        <h2 className='section-subtitle'>Des questions ?</h2>
        <p>Pour toute question ou tout commentaire concernant notre déclaration de confidentialité ou la manière dont BK TRAD traite vos données personnelles, veuillez contacter :  <a href="mailto:kenza.baccouri@gmail.com"><span className='email-link'>kenza.baccouri@gmail.com</span></a>
        </p>
        <h1 className='section-title'>Conditions générales de vente : </h1>
        <h2 className='section-subtitle'>1. Dispositions générales</h2>
        <p>Les présentes conditions générales définissent les obligations respectives des parties contractuelles dans le cadre de prestation de services de KB TRAD.
        </p>
        <p>Les conditions et accords qui suivent, de même que les éventuelles modifications convenues par écrit, sont d’application aux services prestés en faveur du client et/ou du donneur d’ordre.
        </p>
        <p>Les présentes conditions générales remplacent et annulent toutes les autres conditions générales ou conventions, que celle-ci soient orales ou écrites, conclues postérieurement ou antérieurement. Elles priment sur les conditions générales du client, même si celles-ci spécifient qu’elles sont seules valables. La primauté et l’exclusivité des présentes conditions générales constituent un élément essentiel du contrat.</p>
        <h2 className='section-subtitle'>2. Commande</h2>
        <p>Tous les devis et offres de BK TRAD revêtent un caractère purement informatif en n’engagent aucunement BK TRAD tant que celle-ci n’a pas confirmé l’acceptation de l’offre par le client. Les offres et les devis de KB TRAD ne sont valables qu’un mois au maximum.
        </p>
        <p>Un accord n’est parfait qu’à partir du moment où le client accepte l’offre de BK TRAD (soit en renvoyant le devis signé pour accord, soit par retour de courriel) et que BK TRAD confirme que la commande du client peut être exécutée. L’acceptation de l’offre de BK TRAD par le client entraîne l’acceptation expresse des conditions générales et particulières de BK TRAD.
        </p>
        <h2 className='section-subtitle'>3. Prix et paiement</h2>
        <p>Les prix sont libellés en euros hors TVA et les factures sont payables au comptant dans un délai de 15 jours suivant la date de la facture.
        </p>
        <p>Pour les traductions écrites, les prix de base peuvent être majorés en fonction du format des documents à traiter, de la spécificité des textes et du délai d’urgence. Des frais administratifs peuvent être imputés en cas de demande de correction d’une facture déjà établie.
        </p>
        <p>Le montant de la facture doit être réglé par virement SEPA sur le numéro de compte mentionné sur la facture. D’autres modes de paiement doivent expressément et préalablement être convenus avec BK TRAD. Les éventuels frais bancaires sont à la charge du client.
        </p>
        <p>Le paiement partiel du montant de la facture ne constitue pas une contestation.  En cas de non-paiement à l’échéance mentionnée sur la facture, un intérêt de retard de 10 % par mois entamé du montant de la facture est dû de plein droit et sans mise en demeure préalable, à partir de l’échéance, ainsi qu’une indemnité forfaitaire de 10 % du montant de la facture (avec un montant minimum de 150 €) de clause, en plus des frais administratifs de 10 €. Le paiement tardif du montant en principal ne constitue pas l’acquittement des frais supplémentaires susmentionnés.
        </p>
        <p>En cas de non-paiement, d’insolvabilité ou de faillite dans le chef du client, toutes les dettes impayées du client sont immédiatement exigibles, même les dettes qui découlent de factures non échues. Le cas échéant, BK TRAD se réserve le droit de suspendre pour une durée indéterminée les prestations en cours et futures, sans préjudice du droit de BK TRAD de réclamer le paiement immédiat des travaux et des livraisons suspendus.
        </p>
